...
geomE = sm.make_sref(x0=20, y0=15,cellname= "BCELL",group= base,mag=1.0,angle=0,mirror=False)
...
geomE += sm.make_sref(x0=40,y0= 15,cellname= "BCELL", group=base, mag=1.5,angle=45,mirror=False)
...
geomE += sm.make_aref(x0=0,y0=50,cellname="B_TWO",group=b2,ncols=3,nrows= 4,ax= 25.0, ay=0.0,bx= 0.0, by=20.0)
