...
class DirectionalCoupler(Device):
    ...
    def geom(self):
        ...
        self.addlocalport(
            BaseWaveguidePort(-XP, YP, "west", ss.options["defaultWidth"], "p1")
        )
        self.addlocalport(
            BaseWaveguidePort(XP, YP, "east", ss.options["defaultWidth"], "p2")
        )
        self.addlocalport(
            BaseWaveguidePort(-XP, -YP, "west", ss.options["defaultWidth"], "p3")
        )
        self.addlocalport(
            BaseWaveguidePort(XP, -YP, "east", ss.options["defaultWidth"], "p4")
        )
