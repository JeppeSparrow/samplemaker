...
text0 = sm.make_text(x0=0, y0=0, text="DIFF", height=10,width= 2,angle=30,to_poly=True,layer=1)
...
text1 = sm.make_text(x0=0,y0=0,text="DIFF",height=11,width=3,angle=30,to_poly=True,layer=1)
...
text2 = sm.make_text(x0=50,y0=0,text="XOR",height=10,width=1,angle=0,to_poly=True,layer=1)
